      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.1fr 1fr", gap: 48 }} className="detalle-grid">
        ...
        <div>
          ...
          <div style={{ display: "flex", gap: 12, alignItems: "stretch", marginBottom: 24 }}>
            ...
            <TKButton size="lg" full onClick={() => addToCart(product, { color, custom, qty })}>
              Agregar al carrito — {fmtARS(product.price * qty)}
            </TKButton>
          </div>

          <TKButton variant="outline" full size="md">
            Comprar ahora
          </TKButton>
      ...
      <div style={{ padding: "60px 24px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48 }} className="detalle-b-grid">
        ...
        <div>
          ...
          <div style={{ display: "flex", gap: 12 }}>
            ...
            <TKButton size="lg" full onClick={() => addToCart(product, { color, qty })}>
              Agregar al carrito
            </TKButton>
          </div>
        </div>
