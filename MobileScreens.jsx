...
// ========== Mobile Home ==========
export function MobileHome({ go, addToCart }) {
...
// ========== Mobile Catalog hub ==========
export function MobileCatalogoHub({ go }) {
  return (
...
// ========== Mobile Category ==========
export function MobileCategoria({ go, addToCart, cat }) {
...
// ========== Mobile Buscador ==========
export function MobileBuscador({ go, addToCart }) {
...
// ========== Mobile Tab Bar ==========
export function MobileTabBar({ route, go, cartCount, user }) {
  const tabs = [
    ...
    { id: "carrito", label: "Carrito", icon: <Icon.cart size={22}/>, badge: cartCount },
    { id: user ? "perfil" : "auth", label: user ? "Cuenta" : "Ingresar", icon: <Icon.user size={22}/> },
  ];
...
export function MobileHeader({ route, go, user }) {
  const title = {
    ...
    categoria: null, detalle: null, carrito: null, auth: null,
    checkout: "Envío", pago: "Pago", confirmacion: null, perfil: "Mi cuenta", about: "Sobre nosotros",
  }[route];
    ...
    return (
      <header style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "14px 0" }}>
        ...
        <div style={{ display: "flex", gap: 2 }}>
          ...
          <button onClick={() => go(user ? "perfil" : "auth")} style={iconBtnM}><Icon.user size={20}/></button>
        </div>
      </header>
    );
  }
